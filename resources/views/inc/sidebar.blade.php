            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            <a href="/student/view" class="side-menu__item">View Student By Class</a>   
                        </li>
                        <li class="slide">
                            <a href="/student/promote" class="side-menu__item">Promote Student</a>
                        </li>
                        <li class="slide">
                            <a href="/all-student" class="side-menu__item">All Student</a>
                        </li>
                        <li class="slide">
                            <a href="/student/processClearance" class="side-menu__item">Clear & Unclear Student</a>
                        </li>
                    </ul>
                </li>
                <!-- End::slide -->
                ...
                <!-- Start::slide__category -->
                <li class="slide__category"><span class="category-name">EXAM AND RECORD</span></li>
                <!-- End::slide__category -->
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Exam & Record</span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        
                        <li class="slide">
                            <a href="/student/recordExam" class="side-menu__item">Record Test & Exam</a>
                        </li>
                        <li class="slide">
                            <a href="/student/scoreSheet" class="side-menu__item">Score Sheet</a>
                        </li>
                        <li class="slide">
                            <a href="/student/broadSheet" class="side-menu__item">Broad Sheet</a>
                        </li>
                    </ul>
                </li>
                <!-- End::slide -->
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1 mega-menu">
                        ...
                        <li class="slide">
                            <a href="/student/reportSheet" class="side-menu__item">View Student Report</a>
                        </li>
                        <li class="slide">
                            <a href="" class="side-menu__item">Psychomotor Domain</a>
                        </li>
                        <li class="slide">
                            <a href="/student/comment" class="side-menu__item">Teachers Comment</a>
                        </li>
                        <li class="slide">
