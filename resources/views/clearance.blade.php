                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="esxample" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    @foreach ($promotedStudents as $name)
                                        ...
                                        <tr>
                                            <form action="{{ route('submit.clearance') }}" method="post">
                                                @csrf
                                                <td> <input type="checkbox" value="{{ $admissionNo }}" name="admissionNo[]"> {{ $admissionNo }}
                                                </td>


                                                <td style="text-transform: uppercase;">
                                                    {{ optional($name->student)->surname }}</td>
                                                <td style="text-transform: uppercase;">
                                                    {{ optional($name->student)->firstName }}
                                                </td>
                                                <td style="text-transform: uppercase;">
                                                    {{ optional($name->student)->lastName }}</td>
                                ...
                                <input type="hidden" name="clazz" value="{{ $class }}" id="clazz">
                                </form>
                            </table>
